...
{
  interbotix_perception_msgs__srv__FilterParams_Request * msg = (interbotix_perception_msgs__srv__FilterParams_Request *)malloc(sizeof(interbotix_perception_msgs__srv__FilterParams_Request));
  if (!msg) {
    return NULL;
  }
...
interbotix_perception_msgs__srv__FilterParams_Request__Sequence__init(interbotix_perception_msgs__srv__FilterParams_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interbotix_perception_msgs__srv__FilterParams_Request *)calloc(size, sizeof(interbotix_perception_msgs__srv__FilterParams_Request));
    if (!data) {
      return false;
    }
...
{
  interbotix_perception_msgs__srv__FilterParams_Request__Sequence * array = (interbotix_perception_msgs__srv__FilterParams_Request__Sequence *)malloc(sizeof(interbotix_perception_msgs__srv__FilterParams_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  interbotix_perception_msgs__srv__FilterParams_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interbotix_perception_msgs__srv__FilterParams_Request * data =
      (interbotix_perception_msgs__srv__FilterParams_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interbotix_perception_msgs__srv__FilterParams_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interbotix_perception_msgs__srv__FilterParams_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  interbotix_perception_msgs__srv__FilterParams_Response * msg = (interbotix_perception_msgs__srv__FilterParams_Response *)malloc(sizeof(interbotix_perception_msgs__srv__FilterParams_Response));
  if (!msg) {
    return NULL;
  }
...
interbotix_perception_msgs__srv__FilterParams_Response__Sequence__init(interbotix_perception_msgs__srv__FilterParams_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interbotix_perception_msgs__srv__FilterParams_Response *)calloc(size, sizeof(interbotix_perception_msgs__srv__FilterParams_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  interbotix_perception_msgs__srv__FilterParams_Response__Sequence * array = (interbotix_perception_msgs__srv__FilterParams_Response__Sequence *)malloc(sizeof(interbotix_perception_msgs__srv__FilterParams_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  interbotix_perception_msgs__srv__FilterParams_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interbotix_perception_msgs__srv__FilterParams_Response * data =
      (interbotix_perception_msgs__srv__FilterParams_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interbotix_perception_msgs__srv__FilterParams_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interbotix_perception_msgs__srv__FilterParams_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
