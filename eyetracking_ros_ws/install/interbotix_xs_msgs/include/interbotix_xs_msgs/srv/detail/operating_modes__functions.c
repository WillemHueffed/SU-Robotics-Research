...
{
  interbotix_xs_msgs__srv__OperatingModes_Request * msg = (interbotix_xs_msgs__srv__OperatingModes_Request *)malloc(sizeof(interbotix_xs_msgs__srv__OperatingModes_Request));
  if (!msg) {
    return NULL;
  }
...
interbotix_xs_msgs__srv__OperatingModes_Request__Sequence__init(interbotix_xs_msgs__srv__OperatingModes_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interbotix_xs_msgs__srv__OperatingModes_Request *)calloc(size, sizeof(interbotix_xs_msgs__srv__OperatingModes_Request));
    if (!data) {
      return false;
    }
...
{
  interbotix_xs_msgs__srv__OperatingModes_Request__Sequence * array = (interbotix_xs_msgs__srv__OperatingModes_Request__Sequence *)malloc(sizeof(interbotix_xs_msgs__srv__OperatingModes_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  interbotix_xs_msgs__srv__OperatingModes_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interbotix_xs_msgs__srv__OperatingModes_Request * data =
      (interbotix_xs_msgs__srv__OperatingModes_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interbotix_xs_msgs__srv__OperatingModes_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interbotix_xs_msgs__srv__OperatingModes_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  interbotix_xs_msgs__srv__OperatingModes_Response * msg = (interbotix_xs_msgs__srv__OperatingModes_Response *)malloc(sizeof(interbotix_xs_msgs__srv__OperatingModes_Response));
  if (!msg) {
    return NULL;
  }
...
interbotix_xs_msgs__srv__OperatingModes_Response__Sequence__init(interbotix_xs_msgs__srv__OperatingModes_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interbotix_xs_msgs__srv__OperatingModes_Response *)calloc(size, sizeof(interbotix_xs_msgs__srv__OperatingModes_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  interbotix_xs_msgs__srv__OperatingModes_Response__Sequence * array = (interbotix_xs_msgs__srv__OperatingModes_Response__Sequence *)malloc(sizeof(interbotix_xs_msgs__srv__OperatingModes_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  interbotix_xs_msgs__srv__OperatingModes_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interbotix_xs_msgs__srv__OperatingModes_Response * data =
      (interbotix_xs_msgs__srv__OperatingModes_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interbotix_xs_msgs__srv__OperatingModes_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interbotix_xs_msgs__srv__OperatingModes_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
