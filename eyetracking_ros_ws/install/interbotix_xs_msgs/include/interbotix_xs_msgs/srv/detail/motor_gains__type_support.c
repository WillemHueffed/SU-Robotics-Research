...
void MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_init_function(
...
void MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_fini_function(void * message_memory)
{
  interbotix_xs_msgs__srv__MotorGains_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_message_member_array[9] = {
  {
    "cmd_type",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_message_members = {
  ...
  MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_message_member_array,  // message members
  MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_message_type_support_handle = {
  0,
  &MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, MotorGains_Request)() {
  if (!MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_message_type_support_handle.typesupport_identifier) {
    MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &MotorGains_Request__rosidl_typesupport_introspection_c__MotorGains_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_fini_function(void * message_memory)
{
  interbotix_xs_msgs__srv__MotorGains_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_message_members = {
  "interbotix_xs_msgs__srv",  // message namespace
  "MotorGains_Response",  // message name
  1,  // number of fields
  sizeof(interbotix_xs_msgs__srv__MotorGains_Response),
  MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_message_member_array,  // message members
  MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_message_type_support_handle = {
  0,
  &MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, MotorGains_Response)() {
  if (!MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_message_type_support_handle.typesupport_identifier) {
    MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &MotorGains_Response__rosidl_typesupport_introspection_c__MotorGains_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
