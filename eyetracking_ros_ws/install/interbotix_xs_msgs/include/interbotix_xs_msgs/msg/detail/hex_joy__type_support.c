...
void HexJoy__rosidl_typesupport_introspection_c__HexJoy_init_function(
...
void HexJoy__rosidl_typesupport_introspection_c__HexJoy_fini_function(void * message_memory)
{
  interbotix_xs_msgs__msg__HexJoy__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember HexJoy__rosidl_typesupport_introspection_c__HexJoy_message_member_array[17] = {
  {
    "world_x_cmd",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers HexJoy__rosidl_typesupport_introspection_c__HexJoy_message_members = {
  "interbotix_xs_msgs__msg",  // message namespace
  "HexJoy",  // message name
  17,  // number of fields
  sizeof(interbotix_xs_msgs__msg__HexJoy),
  HexJoy__rosidl_typesupport_introspection_c__HexJoy_message_member_array,  // message members
  HexJoy__rosidl_typesupport_introspection_c__HexJoy_init_function,  // function to initialize message memory (memory has to be allocated)
  HexJoy__rosidl_typesupport_introspection_c__HexJoy_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t HexJoy__rosidl_typesupport_introspection_c__HexJoy_message_type_support_handle = {
  0,
  &HexJoy__rosidl_typesupport_introspection_c__HexJoy_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, msg, HexJoy)() {
  if (!HexJoy__rosidl_typesupport_introspection_c__HexJoy_message_type_support_handle.typesupport_identifier) {
    HexJoy__rosidl_typesupport_introspection_c__HexJoy_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &HexJoy__rosidl_typesupport_introspection_c__HexJoy_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
