...
#ifndef INTERBOTIX_XS_MSGS__SRV__DETAIL__REGISTER_VALUES__FUNCTIONS_H_
#define INTERBOTIX_XS_MSGS__SRV__DETAIL__REGISTER_VALUES__FUNCTIONS_H_
...
/// Initialize srv/RegisterValues message.
/**
...
/// Finalize srv/RegisterValues message.
/**
...
/// Create srv/RegisterValues message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interbotix_xs_msgs__srv__RegisterValues_Request__init().
...
/// Destroy srv/RegisterValues message.
/**
 * It calls
 * interbotix_xs_msgs__srv__RegisterValues_Request__fini()
...
/// Check for srv/RegisterValues message equality.
/**
...
/// Copy a srv/RegisterValues message.
/**
...
/// Initialize array of srv/RegisterValues messages.
/**
...
/// Finalize array of srv/RegisterValues messages.
/**
 * It calls
 * interbotix_xs_msgs__srv__RegisterValues_Request__fini()
...
/// Create array of srv/RegisterValues messages.
/**
 * It allocates the memory for the array and calls
 * interbotix_xs_msgs__srv__RegisterValues_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RegisterValues messages.
/**
 * It calls
 * interbotix_xs_msgs__srv__RegisterValues_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RegisterValues message array equality.
/**
...
/// Copy an array of srv/RegisterValues messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interbotix_xs_msgs__srv__RegisterValues_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interbotix_xs_msgs
...
/**
 * It calls
 * interbotix_xs_msgs__srv__RegisterValues_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interbotix_xs_msgs
...
/**
 * It allocates the memory for the array and calls
 * interbotix_xs_msgs__srv__RegisterValues_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interbotix_xs_msgs
...
/**
 * It calls
 * interbotix_xs_msgs__srv__RegisterValues_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERBOTIX_XS_MSGS__SRV__DETAIL__REGISTER_VALUES__FUNCTIONS_H_
