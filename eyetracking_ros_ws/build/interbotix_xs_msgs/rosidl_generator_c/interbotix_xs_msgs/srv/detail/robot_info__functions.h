...
#ifndef INTERBOTIX_XS_MSGS__SRV__DETAIL__ROBOT_INFO__FUNCTIONS_H_
#define INTERBOTIX_XS_MSGS__SRV__DETAIL__ROBOT_INFO__FUNCTIONS_H_
...
/// Initialize srv/RobotInfo message.
/**
...
/// Finalize srv/RobotInfo message.
/**
...
/// Create srv/RobotInfo message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interbotix_xs_msgs__srv__RobotInfo_Request__init().
...
/// Destroy srv/RobotInfo message.
/**
 * It calls
 * interbotix_xs_msgs__srv__RobotInfo_Request__fini()
...
/// Check for srv/RobotInfo message equality.
/**
...
/// Initialize array of srv/RobotInfo messages.
/**
...
/// Finalize array of srv/RobotInfo messages.
/**
 * It calls
 * interbotix_xs_msgs__srv__RobotInfo_Request__fini()
...
/// Create array of srv/RobotInfo messages.
/**
 * It allocates the memory for the array and calls
 * interbotix_xs_msgs__srv__RobotInfo_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RobotInfo messages.
/**
 * It calls
 * interbotix_xs_msgs__srv__RobotInfo_Request__Sequence__fini()
 * on the array,
...
/// Check for srv/RobotInfo message array equality.
/**
...
/// Copy an array of srv/RobotInfo messages.
/**
 * This functions performs a deep copy, as opposed to the shallow copy that
 * plain assignment yields.
 *
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * interbotix_xs_msgs__srv__RobotInfo_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interbotix_xs_msgs
...
/**
 * It calls
 * interbotix_xs_msgs__srv__RobotInfo_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_interbotix_xs_msgs
...
/**
 * It allocates the memory for the array and calls
 * interbotix_xs_msgs__srv__RobotInfo_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_interbotix_xs_msgs
...
/**
 * It calls
 * interbotix_xs_msgs__srv__RobotInfo_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // INTERBOTIX_XS_MSGS__SRV__DETAIL__ROBOT_INFO__FUNCTIONS_H_
