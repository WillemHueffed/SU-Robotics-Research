...
{
  interbotix_xs_msgs__msg__ArmJoy * msg = (interbotix_xs_msgs__msg__ArmJoy *)malloc(sizeof(interbotix_xs_msgs__msg__ArmJoy));
  if (!msg) {
    return NULL;
  }
...
interbotix_xs_msgs__msg__ArmJoy__Sequence__init(interbotix_xs_msgs__msg__ArmJoy__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (interbotix_xs_msgs__msg__ArmJoy *)calloc(size, sizeof(interbotix_xs_msgs__msg__ArmJoy));
    if (!data) {
      return false;
    }
...
{
  interbotix_xs_msgs__msg__ArmJoy__Sequence * array = (interbotix_xs_msgs__msg__ArmJoy__Sequence *)malloc(sizeof(interbotix_xs_msgs__msg__ArmJoy__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  interbotix_xs_msgs__msg__ArmJoy__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    interbotix_xs_msgs__msg__ArmJoy * data =
      (interbotix_xs_msgs__msg__ArmJoy *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!interbotix_xs_msgs__msg__ArmJoy__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          interbotix_xs_msgs__msg__ArmJoy__fini(&data[i]);
        }
        free(data);
        return false;
      }
