...
static const _JointSingleCommand_type_support_symbol_names_t _JointSingleCommand_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, interbotix_xs_msgs, msg, JointSingleCommand)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, interbotix_xs_msgs, msg, JointSingleCommand)),
  }
};
...
{
  return &::interbotix_xs_msgs::msg::rosidl_typesupport_cpp::JointSingleCommand_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, interbotix_xs_msgs, msg, JointSingleCommand)() {
  return get_message_type_support_handle<interbotix_xs_msgs::msg::JointSingleCommand>();
}
