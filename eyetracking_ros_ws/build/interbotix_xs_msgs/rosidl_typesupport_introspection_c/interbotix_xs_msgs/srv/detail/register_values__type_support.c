...
void RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_init_function(
...
void RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_fini_function(void * message_memory)
{
  interbotix_xs_msgs__srv__RegisterValues_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_member_array[4] = {
  {
    "cmd_type",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_members = {
  ...
  RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_member_array,  // message members
  RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_type_support_handle = {
  0,
  &RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Request)() {
  if (!RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_type_support_handle.typesupport_identifier) {
    RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &RegisterValues_Request__rosidl_typesupport_introspection_c__RegisterValues_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_fini_function(void * message_memory)
{
  interbotix_xs_msgs__srv__RegisterValues_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_member_array[1] = {
  {
    "values",  // name
    rosidl_typesupport_introspection_c__ROS_TYPE_INT32,  // type
    0,  // upper bound of string
...
static const rosidl_typesupport_introspection_c__MessageMembers RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_members = {
  "interbotix_xs_msgs__srv",  // message namespace
  "RegisterValues_Response",  // message name
  1,  // number of fields
  sizeof(interbotix_xs_msgs__srv__RegisterValues_Response),
  RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_member_array,  // message members
  RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_type_support_handle = {
  0,
  &RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, RegisterValues_Response)() {
  if (!RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_type_support_handle.typesupport_identifier) {
    RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &RegisterValues_Response__rosidl_typesupport_introspection_c__RegisterValues_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
