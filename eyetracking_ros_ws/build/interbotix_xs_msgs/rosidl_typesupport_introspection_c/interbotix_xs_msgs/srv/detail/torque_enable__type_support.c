...
void TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_init_function(
...
void TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_fini_function(void * message_memory)
{
  interbotix_xs_msgs__srv__TorqueEnable_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_message_member_array[3] = {
  {
    "cmd_type",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_message_members = {
  ...
  TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_message_member_array,  // message members
  TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_message_type_support_handle = {
  0,
  &TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, TorqueEnable_Request)() {
  if (!TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_message_type_support_handle.typesupport_identifier) {
    TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &TorqueEnable_Request__rosidl_typesupport_introspection_c__TorqueEnable_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_fini_function(void * message_memory)
{
  interbotix_xs_msgs__srv__TorqueEnable_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_message_members = {
  "interbotix_xs_msgs__srv",  // message namespace
  "TorqueEnable_Response",  // message name
  1,  // number of fields
  sizeof(interbotix_xs_msgs__srv__TorqueEnable_Response),
  TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_message_member_array,  // message members
  TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_message_type_support_handle = {
  0,
  &TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, interbotix_xs_msgs, srv, TorqueEnable_Response)() {
  if (!TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_message_type_support_handle.typesupport_identifier) {
    TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &TorqueEnable_Response__rosidl_typesupport_introspection_c__TorqueEnable_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
