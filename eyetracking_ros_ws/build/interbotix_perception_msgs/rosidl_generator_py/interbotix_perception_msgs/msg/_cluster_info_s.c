...
bool interbotix_perception_msgs__msg__cluster_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("interbotix_perception_msgs.msg._cluster_info.ClusterInfo", full_classname_dest, 56) == 0);
  }
  interbotix_perception_msgs__msg__ClusterInfo * ros_message = _ros_message;
  {  // frame_id
  ...
  {  // min_z_point
    PyObject * field = PyObject_GetAttrString(_pymsg, "min_z_point");
    if (!field) {
      return false;
    }
    if (!geometry_msgs__msg__point__convert_from_py(field, &ros_message->min_z_point)) {
      Py_DECREF(field);
      return false;
    }
    Py_DECREF(field);
...
{
  /* NOTE(esteve): Call constructor of ClusterInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("interbotix_perception_msgs.msg._cluster_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ClusterInfo");
  ...
  {  // min_z_point
    PyObject * field = NULL;
    field = geometry_msgs__msg__point__convert_to_py(&ros_message->min_z_point);
    if (!field) {
      return NULL;
    }
    {
      int rc = PyObject_SetAttrString(_pymessage, "min_z_point", field);
      Py_DECREF(field);
      if (rc) {
        return NULL;
      }
